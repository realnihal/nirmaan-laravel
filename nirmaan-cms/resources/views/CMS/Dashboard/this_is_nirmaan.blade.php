                        ...
                        <div class="row margin-top-10">
                            <div class="col-xl-12">
                                <div class="dashboard-box margin-top-0">
                                    <div class="headline">
                                        <h3><i class="icon-feather-user-plus"></i> Add Events</h3>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-xl-6">
                                                <div class="submit-field">
                                                    <h5>Event</h5>
                                                    <input name='event_name' type="text"  class="client-name with-border"  required>
                                                </div>
                                            </div>
                                            <div class="col-xl-6">
                                                <div class="submit-field">
                                                    <h5>Date</h5>
                                                    <input name='date' type="text"  class="client-name with-border"  required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="content with-border">
                                        <ul class="dashboard-box-list with-border">
                                            <li>
                                                <div class="job-listing">
                                                    <div class="job-listing-details">
                                                        <div class="job-listing-description">
                                                            <h3 class="job-listing-title">{{ $event->event_name }}
                                                            </h3>
                                                ...
                                                <!-- Buttons -->
                                                <form action="{{route('delete.event',['eventId'=>$event->id])}}" method="post">
                                                    @csrf
                                                <div class=" always-visible">
                                                    <button
                                                        class="button ripple-effect" type="submit"><i
                                                            class="icon-material-outline-delete"></i> Remove Event</button>
